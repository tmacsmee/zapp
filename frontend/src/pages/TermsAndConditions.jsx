  ...
  return (
    <div className="mt-10 w-[80%] mx-auto">
      ...
      <p>
        ...
        of Zapp's Website, located at www.Zapp.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Zapp if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing Zapp, you agreed to use
        cookies in agreement with the Zapp's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Zapp and/or its licensors own the intellectual
        property rights for all material on Zapp. All intellectual property
        rights are reserved. You may access this from Zapp for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Zapp</li>
        <li>Sell, rent or sub-license material from Zapp</li>
        <li>Reproduce, duplicate or copy material from Zapp</li>
        <li>Redistribute content from Zapp</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Zapp
        ...
        of Zapp,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Zapp shall not be liable for the Comments
      ...
      <p>
        Zapp reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Zapp a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Zapp; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Zapp. Please include your name, your organization name,
      ...
      <p>
        No use of Zapp's logo or other artwork will be allowed for linking

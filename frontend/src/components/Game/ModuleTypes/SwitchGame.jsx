    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-4 w-full h-32">
                <div className= {"group relative w-20 h-full p-2 shadow-inner" + (switchPos[0] ? " bg-yellow-300":" bg-gray-200")} onClick={()=>handleSwitch(0)}>
                ...
                <div className= {"group relative w-20 h-full p-2 shadow-inner" + (switchPos[1] ? " bg-yellow-300":" bg-gray-200")} onClick={()=>handleSwitch(1)}>
                ...
                <div className= {"group relative w-20 h-full p-2 shadow-inner" + (switchPos[2] ? " bg-yellow-300":" bg-gray-200")} onClick={()=>handleSwitch(2)}>
                ...
                <div className= {"group relative w-20 h-full p-2 shadow-inner" + (switchPos[3] ? " bg-yellow-300":" bg-gray-200")} onClick={()=>handleSwitch(3)}>
